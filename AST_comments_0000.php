<?php
### AST_comments_0000.php -> blank template; change this to update filename when you use this; uncomment and update necessary items below
### 
...
<html>
<head>
<title>VICIDIAL ADMIN: <!-- add page title here --></title>
...
<CENTER>
<TABLE WIDTH="800" BGCOLOR="#D9E6FE" cellpadding="10" cellspacing="0" border="0"> <!-- change table size here -->
	<TR BGCOLOR="#015B91">
		<TD ALIGN="LEFT">
		
		<!-- main content start here -->
		
		<!-- insert any PHP code here before the main table starts -->
