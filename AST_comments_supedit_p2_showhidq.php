			...
			echo "<TABLE width=\"100%\" cellspacing=\"0\" cellpadding=\"5\" align=\"center\" border = \"0\">\n";
				...
				echo "<tr>";
					echo "<td align=\"center\" bgcolor=\"#B9CBFD\">\n";
						...
						echo "<font color = \"red\" size = \"+1\"><b>The campaign you have selected has not been configured to be scored yet.</b></font><p> \n";
						echo "Please select an action below. \n";
					echo "</td>";
				echo "</tr>";
				echo "<tr>";
					echo "<td align=\"center\" bgcolor=\"#9BB9FB\">\n";
						echo "<input type =\"button\" onclick=\"location.href='AST_comments_supedit.php'\" value=\"Back to Search\" />\n";
						echo "<input type =\"button\" onclick=\"location.href='AST_comments_supedit_p3.php?campaigns=".$sent_cid."'\" value=\"Create Questions and Scoring\" />\n";;
					echo "</td> \n";
				echo "</tr>";
			echo "</table>";
				...
				echo "<tr>";
					echo "<td align=\"center\" bgcolor=\"#B9CBFD\">\n";
						...
						$result2 = mysql_query("SELECT * FROM questions_cid_".$case_cid." ORDER BY seq_num ASC") or die(mysql_error());
						$c = 1;
							...
							$edit_date = $row2['edit_date'];
								...
								echo "<tr bgcolor = ".$bgcolor."> \n";
									...
									echo "<td align = \"justify\" valign = \"top\"> \n";
										if ($status == "INACTIVE"){
											echo "<font color = \"red\">".$question."</font> \n";
										} else {
											echo $question." \n";
										}
									...
									echo "<td align = \"center\" valign = \"top\"> \n";
										if ($status == "INACTIVE"){
											$qstat = "<font color = \"red\"><B><I>NO</I></B></font>";
											echo $qstat." \n";
										} else {
											$qstat = "YES";
											echo $qstat." \n";
				...
				echo "<tr>";
					echo "<td align=\"center\" bgcolor =\"#00468C\">\n";
						echo "<input type =\"button\" onclick=\"location.href='AST_comments_supedit_p2.php?campaigns=".$sent_cid."'\" value=\"Hide Inactive Questions\" />\n";
						echo "<input type =\"button\" onclick=\"location.href='AST_comments_supedit_p3.php?campaigns=".$sent_cid."'\" value=\"Add or Edit Questions\" />\n";
						echo "<input type =\"button\" onclick=\"location.href='AST_comments_supedit.php'\" value=\"Back to Search\" />\n";
					echo "</td> \n";
				echo "</tr>";
			echo "</table>";
