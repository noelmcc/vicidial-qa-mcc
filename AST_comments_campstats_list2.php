...
$pagename = basename($_SERVER['PHP_SELF']);
  ...
  if( (strlen($PHP_AUTH_USER)<2) or (strlen($PHP_AUTH_PW)<2) or (!$auth))
	...
	if ($sent_count == 1) {
		header ("Location: AST_comments_campstats_list3.php?search=".$sent_search."&status=".$sent_status."&statusname=".$sent_statusname."&campaign=".$sent_campaign."&count=".$sent_count."");
		//echo "<a href=\"Location: AST_comments_campstats_list3.php?search=".$sent_search."&status=".$sent_status."&statusname=".$sent_statusname."&campaign=".$sent_campaign."&count=".$sent_count."\">next</a> ";
	} else {}
...
<TABLE WIDTH="520" BGCOLOR="#D9E6FE" cellpadding="10" cellspacing="0" border="0">
	<TR BGCOLOR="#015B91">
		<TD ALIGN="LEFT">
			<a href="./admin.php"><FONT COLOR="WHITE"><B>VICIDIAL ADMIN</a>
		</TD>
		<TD ALIGN="RIGHT">
	...
	echo "<TR BGCOLOR=\"#F0F5FE\">\n";
		echo "<TD ALIGN=\"LEFT\" COLSPAN=\"2\">\n";
			...
			echo "<FONT COLOR=\"BLACK\"><B>No. of Calls Found: ".number_format($sent_count)."</B> <p>\n";
