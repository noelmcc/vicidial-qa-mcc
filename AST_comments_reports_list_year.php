...
$pagename = basename($_SERVER['PHP_SELF']);
  ...
  if( (strlen($PHP_AUTH_USER)<2) or (strlen($PHP_AUTH_PW)<2) or (!$auth))
	...
	if ($_SESSION["campaign_selected"] == "allcamps" || $_SESSION["campaign_selected"] == "") {
		...
		/* $campaign_selected = $campaigns; */
		if (isset($_GET["campaign_choice"]))				{$campaign_selected=$_GET["campaign_choice"];}
		elseif (isset($_POST["campaign_choice"]))		{$campaign_selected=$_POST["campaign_choice"];}
		elseif (isset($_SESSION["campaign_selected"]))		{$campaign_selected=$_SESSION["campaign_selected"];}
	...
	echo "<TR BGCOLOR=\"#F0F5FE\">\n";
		echo "<TD ALIGN=\"LEFT\" COLSPAN=\"2\">\n";
			...
			/* if ($campaign_selected == "allcamps") {
				...
				echo "<option value=\"".$campaign_selected."\" selected = \"selected\">".$campaign_selected."</option> \n";
			...
			echo "<TABLE width=\"100%\" cellspacing=\"0\" cellpadding=\"3\" align=\"center\" border = \"0\">\n";
				...
				echo "<tr>\n";
					echo "<td align=\"center\">\n";
						...
						echo "<TABLE width=\"100%\" cellspacing=\"0\" cellpadding=\"3\" align=\"center\" border = \"1\" bordercolor=\"white\" class=\"tblText\">\n";
							echo "<tr>\n";
							...
							echo "</tr>\n";
								echo "<td align = \"center\" colspan=\"25\" style=\"padding: 0px;\"> \n";
									...
									echo "<iframe allowtransparency=\"true\" src=\"AST_comments_reports_list_year_result.php?campaign_choice=".$campaign_selected."\" width=\"100%\" height=\"250\" frameborder=\"0\" style=\"background-color: #D9E6FE display: block;\" scrolling=\"yes\"> \n";
									echo "</iframe> \n";
